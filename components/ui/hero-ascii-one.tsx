          ...
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Только ты видишь Систему. Каждая тренировка, каждый приём пищи, каждая привычка — это очки опыта. Стань сильнейшим. Подними свой уровень в одиночку.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <a href="/system" className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent text-white font-mono text-xs lg:text-sm border border-white hover:bg-white hover:text-black transition-all duration-200 group text-center">
              ...
              <a href="/onboarding" className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200 text-center" style={{ borderWidth: '1px' }}>
                ОЦЕНКА УРОВНЯ
              </a>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-mono">ARISE.PROTOCOL</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center gap-3 lg:gap-6 text-[8px] lg:text-[9px] font-mono text-white/50">
            ...
            <div className="hidden lg:flex gap-1">
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="w-1 h-3 bg-white/30" style={{ height: `${(i % 4) * 3 + 4}px` }}></div>
              ))}
            </div>
            <span>V1.0.0</span>
          </div>
